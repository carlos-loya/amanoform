...
import com.amanoform.resources.lambda.LambdaFunctionManualProvisioningHandler;
...
public final class ResourceHandlerRegistryFactory {
    ...
    static {
        ...
        HANDLER_REGISTRY.put("af_lambda_function", new LambdaFunctionManualProvisioningHandler());
    }
